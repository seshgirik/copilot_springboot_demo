...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        try {
            ...
            logger.info("                    - Stored hash: {}", userDetails.getPassword());
            logger.info("                    - Stored hash length: {} chars", userDetails.getPassword().length());
            logger.info("                    - Hash algorithm: {}", detectHashAlgorithm(userDetails.getPassword()));
            ...
            if (passwordMatches) {
                ...
                logger.error("                    - Input password: '{}'", password);
                logger.error("                    - Expected pattern: BCrypt hash starting with $2a/$2b/$2y");
                logger.error("                    - Actual hash prefix: {}", userDetails.getPassword().substring(0, Math.min(10, userDetails.getPassword().length())));
