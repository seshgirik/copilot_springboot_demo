...
public class HttpBodyLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, 
        ...
        if (shouldSkipLogging(request.getRequestURI()) || isSensitiveEndpoint(request.getRequestURI())) {
    ...
    private boolean isSensitiveEndpoint(String uri) {
        if (uri == null) return false;
        // Add more patterns as needed for endpoints that handle sensitive data
        return uri.contains("/auth/") || uri.contains("/login") || uri.contains("/register") || uri.contains("/password");
    }
}
