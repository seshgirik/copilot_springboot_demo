...
class RateLimitFilterTest {
    ...
    class ConfigurationTests {
        ...
        @Test
        @DisplayName("Should handle zero requests per minute")
        void shouldHandleZeroRequestsPerMinute() throws ServletException, IOException {
            ReflectionTestUtils.setField(rateLimitFilter, "requestsPerMinute", 0);
