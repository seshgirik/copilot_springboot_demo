...
class HttpBodyLoggingFilterTest {
    ...
    class SensitiveEndpointTests {
        ...
        void shouldSkipLoggingForAuthEndpoints() throws ServletException, IOException {
            System.out.println("START: HttpBodyLoggingFilterTest.SensitiveEndpointTests.shouldSkipLoggingForAuthEndpoints");
            ...
            System.out.println("END: HttpBodyLoggingFilterTest.SensitiveEndpointTests.shouldSkipLoggingForAuthEndpoints");
        }
